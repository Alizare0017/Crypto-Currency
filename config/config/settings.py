...
SECRET_KEY = 'django-insecure-v&n%(45zb2_64jw%g%l9np3!u4uha^7h155i#7y(3syh**1rmk'
...
USERNAME_REGEX = r"^(?=.{6,50}$)(?![_.])(?!.*[_.]{2})[a-z0-9._]+(?<![_.])$"
...
CELERY_ACCEPT_CONTENT = ['json','application/jason']
